...
**MaMo Connector** (also known as **Mamo Connector Launcher**) is a lightweight, open-source desktop companion client for the **Magic Moment (MaMo)** playtesting platform. 
